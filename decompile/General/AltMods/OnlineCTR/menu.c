...
void NewPage_Laps()
{
	...
	sdata->lngStrings[0x9a] = "1 Vuelta";
	sdata->lngStrings[0x9b] = "3 Vueltas";
	sdata->lngStrings[0x9c] = "5 Vueltas";
	sdata->lngStrings[0x9d] = "7 Vueltas";
	...
	// Monday event
	sdata->lngStrings[0x9e] = "15 Vueltas";
	sdata->lngStrings[0x9f] = "30 Vueltas";
	sdata->lngStrings[0xa0] = "SEX:YES - 69";
	sdata->lngStrings[0xa1] = "120 Vueltas";
...
void PrintCharacterStats()
{
	...
	char* title = "Modo clasico";

	if(octr->special == 1)
	{
		title = "Wumpas al maximo";
	}

	if(octr->special == 2)
	{
		title = "Super Turbo Pads";
	}

	if(octr->special == 3)
	{
		title = "Pistas de Hielo";
	}

	DecalFont_DrawLine(title,0x100,0x18,FONT_SMALL,JUSTIFY_CENTER|PENTA_WHITE);
	...
	DecalFont_DrawLine(
		...
		0x100, 0x20, FONT_SMALL, JUSTIFY_CENTER|ORANGE);
	...
	DecalFont_DrawLine(
		roomName,
		0x100, 0x28, FONT_SMALL, JUSTIFY_CENTER|ORANGE);
	...
	DecalFont_DrawLine("Version sin soporte",posX,posY,FONT_SMALL,RED);
	DecalFont_DrawLine("De los desarolladores",posX-0x8,posY+0x8,FONT_SMALL,RED);
	DecalFont_DrawLine("No reportes bugs",posX-0x18,posY+0x10,FONT_SMALL,0);
}
